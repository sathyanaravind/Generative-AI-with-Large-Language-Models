...
[Generative AI use cases, project lifecycle, and model pre-training](#Generative-AI-use-cases-project-lifecycle-and-model-pre-training)
...
- [ReinforcementLearning from Human Feedback (RLHF)](#Reinforcement-Learning-from-Human-Feedback-(RLHF))
